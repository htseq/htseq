...
exec(
    compile(
        open(os.path.join("..", "doc", "code_examples", "tss1.py")).read(),
        os.path.join("..", "doc", "tss1.py"),
        "exec",
    )
)
...
exec(
    compile(
        open(os.path.join("..", "doc", "code_examples", "tss2.py")).read(),
        os.path.join("..", "doc", "tss2.py"),
        "exec",
    )
)
...
exec(
    compile(
        open(os.path.join("..", "doc", "code_examples", "tss3.py")).read(),
        os.path.join("..", "doc", "tss3.py"),
        "exec",
    )
)
