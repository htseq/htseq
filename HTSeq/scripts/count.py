...
def count_reads_in_features(
    ...
    # Prepare features
    args, attributes = _prepare_args_for_count(add_chromosome_info, additional_attributes, feature_query, feature_type,
                                               gff_filename, id_attribute, max_buffer_size, minaqual, multimapped_mode,
                                               order, overlap_mode, quiet, sam_filenames, samout_format, samouts,
                                               secondary_alignment_mode, stranded, supplementary_alignment_mode)
...
def _prepare_args_for_count(add_chromosome_info, additional_attributes, feature_query, feature_type, gff_filename,
                            id_attribute, max_buffer_size, minaqual, multimapped_mode, order, overlap_mode, quiet,
                            sam_filenames, samout_format, samouts, secondary_alignment_mode, stranded,
                            supplementary_alignment_mode):
